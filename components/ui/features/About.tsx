        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <Reveal className="space-y-6">
            ...
            <p className="text-lg text-zinc-600 leading-relaxed">
              ...
              la creación de soluciones digitales. Fundamos MG Tech para cerrar
          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Reveal delay={260} hover="soft">
                <div className="rounded-2xl bg-zinc-900 p-6 text-white h-full">
              ...
              <Reveal delay={340} hover="soft">
                <div className="rounded-2xl bg-blue-600 p-6 text-white h-full">
